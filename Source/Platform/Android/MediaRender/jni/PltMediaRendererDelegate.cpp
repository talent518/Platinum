...
/*----------------------------------------------------------------------
|   PltMediaRendererDelegate::OnGetMediaInfo
+---------------------------------------------------------------------*/
NPT_Result
PltMediaRendererDelegate::OnGetMediaInfo(PLT_ActionReference& action)
{
	LOGI("OnGetMediaInfo");
...
/*----------------------------------------------------------------------
|   PltMediaRendererDelegate::OnGetPositionInfo
+---------------------------------------------------------------------*/
NPT_Result
PltMediaRendererDelegate::OnGetPositionInfo(PLT_ActionReference& action)
{
	LOGI("OnGetPositionInfo");
